...
TRAINING_FILE = 'facerec/training.xml'

# Directories which contain the positive and negative training image data.
POSITIVE_DIR = './facerec/training/positive'
NEGATIVE_DIR = './facerec/training/negative'
...
HAAR_FACES = 'facerec/haarcascade_frontalface_alt.xml'
